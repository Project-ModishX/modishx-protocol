...
contract Marketplace {
    ...
    function get_listing_fee(uint8 _amount) 
        external 
        view 
        returns(
            uint256
    ...
    function get_item(uint256 _listing_id) 
        external 
        view 
        returns(
            uint256
    ...
    function get_items(uint8 _amount, uint256 _skip, bool _skip_sold) 
        external 
        view 
        returns(
            uint256
    ...
    /// @param _skip: this is the number of items should be skipping before fetching (similar to pagination)
    /// @param _skip_sold: this switch is used to tell the function to return sold items or not 
    function get_items_by_nft_address(address _token_adddress, uint8 _amount, uint256 _skip, bool _skip_sold) 
        external 
        view 
        returns(
            uint256 
